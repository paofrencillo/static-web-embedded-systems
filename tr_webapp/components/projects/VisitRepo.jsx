        ...
        <div className={styles.container}>
            ...
            <div className={styles.github_container}>
                <div className={styles.github_links_wrapper}>
                    <Link className={styles.github_links} href={'https://github.com/paopaolopaoloo/THESIS-WEB-APP'} target={'_blank'}>
                        <img className={styles.github_img} src="/images/github.png" alt="github" />
                        <h4 className={styles.github_repo}>Tool Keeper System</h4>
                    </Link>
                </div>
                <div className={styles.github_links_wrapper}>
                    <Link className={styles.github_links} href={'https://github.com/paopaolopaoloo/static_web'} target={'_blank'}>
                        <img className={styles.github_img} src="/images/github.png" alt="github" />
